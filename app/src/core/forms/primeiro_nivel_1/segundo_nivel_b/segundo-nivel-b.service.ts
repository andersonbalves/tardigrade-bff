...
@Injectable()
export class SegundoNivelBFormService implements FormService {
  private _id = 'v1/form/primeiro_nivel_1/segundo_nivel_b';
  private _label = 'Segundo Nível - B';
  private _menuPath = ['Primeiro Nível - 1'];
